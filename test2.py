...
norm_images, norm_labels = load_normal('../PneumoniaDetectionAI/chest_xray/train/NORMAL/')
...
norm_images_test, norm_labels_test = load_normal('../PneumoniaDetectionAI/chest_xray/test/NORMAL/')
pneu_images_test, pneu_labels_test = load_pneumonia('../PneumoniaDetectionAI/chest_xray/test/PNEUMONIA/')
